...
# ---------------------------------------------------------------------------- #
_C.MODEL.CASCADE_RCNN_ROI_HEADS = CN()
_C.MODEL.CASCADE_RCNN_ROI_HEADS.USE_FPN = False
_C.MODEL.CASCADE_RCNN_ROI_HEADS.FG_IOU_THRESHOLD1 = 0.5
_C.MODEL.CASCADE_RCNN_ROI_HEADS.BG_IOU_THRESHOLD1 = 0.5
_C.MODEL.CASCADE_RCNN_ROI_HEADS.BBOX_REG_WEIGHTS1 = (10., 10., 5., 5.)
_C.MODEL.CASCADE_RCNN_ROI_HEADS.BATCH_SIZE_PER_IMAGE = 512
_C.MODEL.CASCADE_RCNN_ROI_HEADS.POSITIVE_FRACTION = 0.25
_C.MODEL.CASCADE_RCNN_ROI_HEADS.SCORE_THRESH = 0.05
_C.MODEL.CASCADE_RCNN_ROI_HEADS.NMS1 = 0.5
_C.MODEL.CASCADE_RCNN_ROI_HEADS.DETECTIONS_PER_IMAGE = 100
_C.MODEL.CASCADE_RCNN_ROI_HEADS.FG_IOU_THRESHOLD2 = 0.6
_C.MODEL.CASCADE_RCNN_ROI_HEADS.BG_IOU_THRESHOLD2 = 0.6
_C.MODEL.CASCADE_RCNN_ROI_HEADS.BBOX_REG_WEIGHTS2 = (20., 20., 10., 10.)
_C.MODEL.CASCADE_RCNN_ROI_HEADS.NMS2 = 0.6
_C.MODEL.CASCADE_RCNN_ROI_HEADS.FG_IOU_THRESHOLD3 = 0.7
_C.MODEL.CASCADE_RCNN_ROI_HEADS.BG_IOU_THRESHOLD3 = 0.7
_C.MODEL.CASCADE_RCNN_ROI_HEADS.BBOX_REG_WEIGHTS3 = (30., 30., 15., 15.)
_C.MODEL.CASCADE_RCNN_ROI_HEADS.NMS3 = 0.7
_C.MODEL.CASCADE_RCNN_ROI_HEADS.LOSS_WEIGHT1 = 1
_C.MODEL.CASCADE_RCNN_ROI_HEADS.LOSS_WEIGHT2 = 0.5
_C.MODEL.CASCADE_RCNN_ROI_HEADS.LOSS_WEIGHT3 = 0.25
